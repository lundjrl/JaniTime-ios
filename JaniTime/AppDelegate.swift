...
//        GMSServices.provideAPIKey("AIzaSyDeXVoE-GRg-9HbwbSbMHE21gUsIGEYqnk")
        ...
        if JaniTime.user.client_id == "" && JaniTime.user.client_company == "" {
            ...
            resetAppToFirstController(sBID: Constants.StoryBoardID.defaultVC)
        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "JaniTime")
    ...
    func resetAppToFirstController(sBID: String) {
        self.window?.rootViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "\(sBID)") as UIViewController
    }
